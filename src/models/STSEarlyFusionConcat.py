...
class STSEarlyFusionConcat(LEAStereo):
    def __init__(self, max_disp=192):
        ...
        self.matching = MatchingNetwork(in_channels=128) 
    ...
    def convert_weights(self,state_dict, weights_source):
        ...
        if weights_source is STSEarlyFusionConcat:
            return state_dict
        elif weights_source is LEAStereo:
            # clear affected weights
            print("===> converting from LEAStereo weights")
