...
METHODS=( STSEarlyFusionConcat STSEarlyFusionConcat2 STSEarlyFusionConcat2Big STSEarlyFusionConcat2Big_712 STSEarlyFusionConcat2Big_4918 STSEarlyFusionConcat2Big_9205 STSEarlyFusionTimeMatch )
...
echo $METHOD_NAME
echo $RESUME_METHOD 
python gen_predictions.py splits.json ../datasets --resume "${WEIGHTS_DIR}/${i}/best.pth" --resume_method "${RESUME_METHOD}" --method "${METHOD_NAME}" --save_name "${i}_t1=t0" -rk '{"l1":"l0","r1":"r0"}'
done 
